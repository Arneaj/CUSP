...
std::vector<Point> extend_streamline(const Matrix& V, const std::vector<Point>& streamline, double step, int max_length)
{
    double starting_x = V.get_shape().x * 0.8;         // TODO: FIX MAGIC NUMBER
