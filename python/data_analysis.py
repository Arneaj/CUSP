...
# # Simulate some physics relationships
# # Inputs: temperature, pressure, velocity, magnetic_field, density
# inputs = 

# # Outputs: completely unknown relationships - just correlated noise
# # This simulates real experimental data where you don't know the physics
# outputs = np.random.randn(n_samples, n_outputs) * 0.5  # measurement noise

# # Hidden correlations you're unaware of:
# influence_matrix = np.random.randn(3, n_outputs)  # Random influences
# hidden_factors = np.column_stack([hidden_factor_1, hidden_factor_2, hidden_factor_3])
# outputs += hidden_factors @ influence_matrix

# # Create column names
# input_names = ['Temperature', 'Pressure', 'Velocity', 'Magnetic_Field', 'Density']
...
#     outputs, output_names, "Output Parameters PCA"
# )
...
#     inputs, input_names, "Input Parameters PCA"
# )
